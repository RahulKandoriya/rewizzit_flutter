...
class RecentCardModelWidget extends StatefulWidget {
  final RecentCards cardModel;
  final SharedPreferences prefs;
  final RecentCardsBloc recentCardsBloc;

  const RecentCardModelWidget({Key key, @required this.cardModel, @required this.prefs, @required this.recentCardsBloc}) : super(key: key);

  @override
  _RecentCardModelWidgetState createState() => _RecentCardModelWidgetState();
}


class _RecentCardModelWidgetState extends State<RecentCardModelWidget> with SingleTickerProviderStateMixin{

  final Repository _repository = Repository();
  SharedPreferences get prefs => widget.prefs;
  RecentCardsBloc get bookmarkBloc => widget.recentCardsBloc;
