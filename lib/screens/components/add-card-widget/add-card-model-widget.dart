...
class AddCardModelWidget extends StatefulWidget {

  const AddCardModelWidget({Key key,}) : super(key: key);

  @override
  _AddCardModelWidgetState createState() => _AddCardModelWidgetState();
}


class _AddCardModelWidgetState extends State<AddCardModelWidget> with SingleTickerProviderStateMixin{
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => SelectNodeScreen(repository: _repository)));
                      },
                      child: Chip(
