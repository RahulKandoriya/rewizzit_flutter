...
class AddCollectionPage extends StatefulWidget {
  ...
  AddCollectionPage({Key key, @required Repository repository, @required this.prefs})
...
class _AddCollectionPageState extends State<AddCollectionPage> with SingleTickerProviderStateMixin {
  ...
  AddCollectionBloc _addCollectionBloc;


  bool get isPopulated =>
      _titleController.text.isNotEmpty;

  bool isSubmitButtonEnabled(AddCollectionState state) {
  ...
  @override
  void initState() {
    _addCollectionBloc = BlocProvider.of<AddCollectionBloc>(context);
